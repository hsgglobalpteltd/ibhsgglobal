          ...
          <div className="w-full max-w-sm bg-white border border-slate-200 rounded-2xl p-8 shadow-xl flex flex-col gap-6 items-center text-center">
            ...
            {!showPinLogin ? (
              <div className="w-full flex flex-col items-center gap-3">
                ...
                {/* Small text under Google Login */}
                <button
                  type="button"
                  onClick={() => {
                    setShowPinLogin(true);
                    setTimeout(() => pinInputsRef.current[0]?.focus(), 60);
                  }}
                  className="inline-flex items-center gap-1.5 text-xs text-zinc-500 hover:text-[#0B57D0] transition-colors cursor-pointer font-medium hover:underline focus:outline-none pt-1"
                >
                  <KeyRound className="w-3.5 h-3.5" />
                  <span>Login with Employee PIN</span>
                </button>
              </div>
            ) : (
              <div className="w-full flex flex-col items-center gap-4 animate-in fade-in duration-200">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs text-zinc-500 hover:text-zinc-800 transition-colors cursor-pointer font-medium hover:underline focus:outline-none"
                >
