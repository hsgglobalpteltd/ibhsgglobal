              ...
              <div className="flex items-center gap-2.5">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {viewingBatch.status === "claimed_to_finance" ? (
                      <span className="px-2 py-0.5 text-[11px] font-medium bg-blue-50 text-blue-800 rounded border border-blue-200 flex items-center gap-1">
                        Claimed to Finance
                      </span>
