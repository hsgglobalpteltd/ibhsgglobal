...
export function SidePanel({ activeItem, onSelectMenu, user, profile, onLogout }: SidePanelProps) {
  ...
  return (
    <aside className={`side-panel relative flex h-screen flex-col justify-between bg-[#F0F4F9] p-6 shadow-[inset_-1px_0_0_0_rgba(0,0,0,0.05)] select-none transition-all duration-300 ease-in-out ${isCollapsed ? "w-[72px] px-3" : "w-64"}`}>
